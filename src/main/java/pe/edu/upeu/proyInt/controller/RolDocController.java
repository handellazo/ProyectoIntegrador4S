...
public class RolDocController {
    ...
    public ResponseEntity<RolDocEntity> crearRolDoc(@RequestBody RolDocEntity rolDoc) {
    ...
    public ResponseEntity<RolDocEntity> updateRolDoc(@PathVariable Integer id, @RequestBody RolDocEntity newRolDoc) {
